...
//    uses net.siisise.bind.format.TypeFormat;
    ...
    provides javax.json.bind.spi.JsonbProvider with net.siisise.json.bind.spi.JSONBProvider;
    provides javax.json.spi.JsonProvider with net.siisise.json.spi.JSONPProvider;
    provides net.siisise.bind.format.TypeFormat with
            net.siisise.json.bind.target.JSONConvert,
