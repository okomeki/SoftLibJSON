 ...
 *
 */
public class SLJsonParserFactoryTest {
    
    public SLJsonParserFactoryTest() {
    }
    ...
    /**
     * Test of createParser method, of class SLJsonParserFactory.
     */
    @Test
    public void testCreateParser_Reader() {
        ...
        SLJsonParserFactory instance = new SLJsonParserFactory();
    ...
    public void testCreateParser_InputStream() {
        ...
        SLJsonParserFactory instance = new SLJsonParserFactory();
        SLJsonParser result = (SLJsonParser) instance.createParser(in);
        assertNotNull(result);
    ...
    /**
     * Test of getConfigInUse method, of class SLJsonParserFactory.
     */
    @Test
